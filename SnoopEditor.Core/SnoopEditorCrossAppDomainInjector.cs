namespace Snoop.Infrastructure
{
    ...
    [Serializable]
    public class SnoopEditorCrossAppDomainInjector : MarshalByRefObject
    {
        public SnoopEditorCrossAppDomainInjector()
        {
    ...
    public class SnoopEditorManager
    {
        [PublicAPI]
        public static int StartEditorSnoop(string settingsFile)
        {
            try
            {
                return new SnoopEditorManager().StartSnoopInstance(settingsFile)
                    ? 0
                    : 2;
            }
